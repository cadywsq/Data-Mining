...
public class DecisionTree {
    ...
    // Data set will be modified by this method, it must be either passed as
    // copy or reconstructed
...
//             }
    ...
    private double numericConditionalEntropy(List<Instance> instances, Attribute attribute) {
...
//         Calculate entropy
    ...
    // Returns the label of majority of instances, resolves ties with label of
    // first instance
